...
const MsgDeposit = Root.kava.MsgDeposit;
MsgDeposit.prototype.type = Config.kava.tx.deposit.prefix;
MsgDeposit.prototype.GetSignBytes = function () {
    let depositor = BECH32.encode(Config.kava.bech32.accAddr, this.depositor);
    let signMsg = {
...
const MsgVote = Root.kava.MsgVote;
MsgVote.prototype.type = Config.kava.tx.vote.prefix;
MsgVote.prototype.GetSignBytes = function () {
    let voter = BECH32.encode(Config.kava.bech32.accAddr, this.voter);
    let signMsg = {
        proposal_id: `${this.proposalID}`,
        voter: voter,
