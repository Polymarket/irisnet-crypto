...
const { MsgSetWithdrawAddress } = Root.kava;
const { MsgWithdrawDelegatorReward } = Root.kava;
const { MsgWithdrawValidatorCommission } = Root.kava;
...
MsgSetWithdrawAddress.prototype.toJSON = function () {
  const delegator_addr = BECH32.encode(Config.kava.bech32.accAddr, this.DelegatorAddress);
  const withdraw_addr = BECH32.encode(Config.kava.bech32.accAddr, this.WithdrawAddress);
  return {
    DelegatorAddress: delegator_addr,
    WithdrawAddress: withdraw_addr,
  };
...
MsgWithdrawDelegatorReward.prototype.toJSON = function () {
  const delegatorAddr = BECH32.encode(Config.kava.bech32.accAddr, this.DelegatorAddress);
  const validatorAddress = BECH32.encode(Config.kava.bech32.accAddr, this.ValidatorAddress);
  return {
...
MsgWithdrawDelegatorReward.prototype.GetDisplayContent = function () {
  const delegatorAddress = BECH32.encode(Config.kava.bech32.accAddr, this.DelegatorAddress);
  const validatorAddress = BECH32.encode(Config.kava.bech32.valAddr, this.ValidatorAddress);
