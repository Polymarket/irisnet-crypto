...
class KavaKeypair {
  static getPrivateKeyFromSecret(mnemonicS) {
    ...
    const derivedPriv = Hd.DerivePrivateKeyForPath(master.secret, master.chainCode, Config.kava.bip39Path);
    return derivedPriv;
  }
  ...
  static create(language) {
    ...
    pubKey = Amino.MarshalBinary(Config.kava.amino.pubKey, pubKey);
  ...
  static isValidAddress(address) {
    const prefix = Config.kava.bech32.accAddr;
