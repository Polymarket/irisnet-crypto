...
const MsgSend = Root.kava.MsgSend;
...
MsgSend.prototype.GetDisplayContent = function (){
    let from = BECH32.encode(Config.kava.bech32.accAddr,this.FromAddress);
    let to = BECH32.encode(Config.kava.bech32.accAddr,this.ToAddress);
    return {
