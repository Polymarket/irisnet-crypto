...
const { MsgDelegate } = Root.kava;
const { MsgUndelegate } = Root.kava;
const { MsgBeginRedelegate } = Root.kava;
...
MsgBeginRedelegate.prototype.GetDisplayContent = function () {
  const delegatorAddress = BECH32.encode(Config.kava.bech32.accAddr, this.DelegatorAddress);
  const validatorSrcAddress = BECH32.encode(Config.kava.bech32.valAddr, this.ValidatorSrcAddress);
  const validatorDstAddress = BECH32.encode(Config.kava.bech32.valAddr, this.ValidatorDstAddress);
