...
const MsgDelegate = Root.kava.MsgDelegate;
const MsgUndelegate = Root.kava.MsgUndelegate;
const MsgBeginRedelegate = Root.kava.MsgBeginRedelegate;

MsgDelegate.prototype.type = Config.kava.tx.delegate.prefix;
...
MsgUndelegate.prototype.type = Config.kava.tx.undelegate.prefix;
...
MsgBeginRedelegate.prototype.type = Config.kava.tx.beginRedelegate.prefix;
MsgBeginRedelegate.prototype.GetSignBytes = function () {
    let msg = {
        delegator_address: BECH32.encode(Config.kava.bech32.accAddr,this.DelegatorAddress),
        validator_src_address: BECH32.encode(Config.kava.bech32.valAddr,this.ValidatorSrcAddress),
        validator_dst_address: BECH32.encode(Config.kava.bech32.valAddr,this.ValidatorDstAddress),
        amount: this.Amount
    };
    let sortMsg = Utils.sortObjectKeys(msg);
    return Amino.MarshalJSON(this.type, sortMsg)
...
MsgBeginRedelegate.prototype.GetDisplayContent = function (){
    let delegatorAddress = BECH32.encode(Config.kava.bech32.accAddr,this.DelegatorAddress);
    let validatorSrcAddress = BECH32.encode(Config.kava.bech32.valAddr,this.ValidatorSrcAddress);
    let validatorDstAddress = BECH32.encode(Config.kava.bech32.valAddr,this.ValidatorDstAddress);
