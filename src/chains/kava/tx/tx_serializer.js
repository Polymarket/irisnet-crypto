...
class TxSerializer {
    ...
    static encode(object) {
        ...
        let fee = object.fee;
        let StdFee = root.kava.StdFee;
        let feeMsg = StdFee.create(fee);

        let StdSignature = root.kava.StdSignature;
        let signature;
        ...
        let txPreBuf = Buffer.from(amino.GetRegisterInfo(config.kava.tx.stdTx.prefix).prefix);
