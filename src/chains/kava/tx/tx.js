...
$root.kava = (function() {
    ...
    kava.Coin = (function() {
        ...
        Coin.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.Coin();
        ...
        Coin.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.Coin)
                return object;
    ...
    kava.MsgSend = (function() {
        ...
        MsgSend.encode = function encode(message, writer) {
            ...
            if (message.Amount != null && message.Amount.length)
                for (var i = 0; i < message.Amount.length; ++i)
                    $root.kava.Coin.encode(message.Amount[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };
        ...
        MsgSend.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgSend();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        MsgSend.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgSend)
                return object;
            ...
            if (object.Amount) {
                if (!Array.isArray(object.Amount))
                    throw TypeError(".kava.MsgSend.Amount: array expected");
                message.Amount = [];
                for (var i = 0; i < object.Amount.length; ++i) {
                    if (typeof object.Amount[i] !== "object")
                        throw TypeError(".kava.MsgSend.Amount: object expected");
        ...
        MsgSend.toObject = function toObject(message, options) {
            ...
            if (message.Amount && message.Amount.length) {
                ...
                for (var j = 0; j < message.Amount.length; ++j)
                    object.Amount[j] = $root.kava.Coin.toObject(message.Amount[j], options);
            }
            return object;
        };
    ...
    kava.MsgDelegate = (function() {
        ...
        MsgDelegate.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgDelegate();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        MsgDelegate.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgDelegate)
                return object;
            ...
            if (object.Amount != null) {
                if (typeof object.Amount !== "object")
                    throw TypeError(".kava.MsgDelegate.Amount: object expected");
        ...
        MsgDelegate.toObject = function toObject(message, options) {
            ...
            if (message.Amount != null && message.hasOwnProperty("Amount"))
                object.Amount = $root.kava.Coin.toObject(message.Amount, options);
            return object;
        };
    ...
    kava.MsgUndelegate = (function() {
        ...
        MsgUndelegate.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgUndelegate();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        MsgUndelegate.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgUndelegate)
                return object;
            ...
            if (object.Amount != null) {
                if (typeof object.Amount !== "object")
                    throw TypeError(".kava.MsgUndelegate.Amount: object expected");
                message.Amount = $root.kava.Coin.fromObject(object.Amount);
            }
            return message;
        };
    ...
    kava.MsgBeginRedelegate = (function() {
        ...
        MsgBeginRedelegate.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgBeginRedelegate();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        MsgBeginRedelegate.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgBeginRedelegate)
                return object;
            ...
            if (object.Amount != null) {
                if (typeof object.Amount !== "object")
                    throw TypeError(".kava.MsgBeginRedelegate.Amount: object expected");
                message.Amount = $root.kava.Coin.fromObject(object.Amount);
            }
            return message;
        };
    ...
    kava.MsgSetWithdrawAddress = (function() {
        ...
        MsgSetWithdrawAddress.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgSetWithdrawAddress();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        MsgSetWithdrawAddress.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgSetWithdrawAddress)
                return object;
    ...
    kava.MsgWithdrawDelegatorReward = (function() {
        ...
        MsgWithdrawDelegatorReward.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgWithdrawDelegatorReward();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        MsgWithdrawDelegatorReward.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgWithdrawDelegatorReward)
                return object;
    ...
    kava.MsgWithdrawValidatorCommission = (function() {
        ...
        MsgWithdrawValidatorCommission.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgWithdrawValidatorCommission();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        MsgWithdrawValidatorCommission.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgWithdrawValidatorCommission)
                return object;
    ...
    kava.MsgDeposit = (function() {
        ...
        MsgDeposit.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgDeposit();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        MsgDeposit.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgDeposit)
                return object;
            ...
            if (object.amount) {
                if (!Array.isArray(object.amount))
                    throw TypeError(".kava.MsgDeposit.amount: array expected");
                message.amount = [];
                for (var i = 0; i < object.amount.length; ++i) {
                    if (typeof object.amount[i] !== "object")
                        throw TypeError(".kava.MsgDeposit.amount: object expected");
                    message.amount[i] = $root.kava.Coin.fromObject(object.amount[i]);
                }
            }
            return message;
    ...
    kava.MsgVote = (function() {
        ...
        MsgVote.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.MsgVote();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        MsgVote.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.MsgVote)
                return object;
    ...
    kava.StdFee = (function() {
        ...
        StdFee.encode = function encode(message, writer) {
            ...
            if (message.amount != null && message.amount.length)
                for (var i = 0; i < message.amount.length; ++i)
                    $root.kava.Coin.encode(message.amount[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        ...
        StdFee.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.StdFee();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        StdFee.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.StdFee)
                return object;
            var message = new $root.kava.StdFee();
            if (object.amount) {
                if (!Array.isArray(object.amount))
                    throw TypeError(".kava.StdFee.amount: array expected");
                message.amount = [];
                for (var i = 0; i < object.amount.length; ++i) {
                    if (typeof object.amount[i] !== "object")
                        throw TypeError(".kava.StdFee.amount: object expected");
                    message.amount[i] = $root.kava.Coin.fromObject(object.amount[i]);
                }
            }
            if (object.gas != null)
    ...
    kava.StdSignature = (function() {
        ...
        StdSignature.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.StdSignature();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        StdSignature.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.StdSignature)
                return object;
    ...
    kava.StdTx = (function() {
        ...
        StdTx.encode = function encode(message, writer) {
            ...
            if (message.signatures != null && message.signatures.length)
                for (var i = 0; i < message.signatures.length; ++i)
                    $root.kava.StdSignature.encode(message.signatures[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
        ...
        StdTx.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.kava.StdTx();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        StdTx.fromObject = function fromObject(object) {
            if (object instanceof $root.kava.StdTx)
                return object;
            var message = new $root.kava.StdTx();
            if (object.msg) {
                if (!Array.isArray(object.msg))
                    throw TypeError(".kava.StdTx.msg: array expected");
                message.msg = [];
            ...
            if (object.fee != null) {
                if (typeof object.fee !== "object")
                    throw TypeError(".kava.StdTx.fee: object expected");
                message.fee = $root.kava.StdFee.fromObject(object.fee);
            }
            if (object.signatures) {
                if (!Array.isArray(object.signatures))
                    throw TypeError(".kava.StdTx.signatures: array expected");
                message.signatures = [];
                for (var i = 0; i < object.signatures.length; ++i) {
                    if (typeof object.signatures[i] !== "object")
                        throw TypeError(".kava.StdTx.signatures: object expected");
        ...
        StdTx.toObject = function toObject(message, options) {
            ...
            if (message.fee != null && message.hasOwnProperty("fee"))
                object.fee = $root.kava.StdFee.toObject(message.fee, options);
            if (message.signatures && message.signatures.length) {
                object.signatures = [];
                for (var j = 0; j < message.signatures.length; ++j)
                    object.signatures[j] = $root.kava.StdSignature.toObject(message.signatures[j], options);
            }
            if (message.memo != null && message.hasOwnProperty("memo"))
