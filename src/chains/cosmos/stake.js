...
const { MsgDelegate } = Root.cosmos;
const { MsgUndelegate } = Root.cosmos;
const { MsgBeginRedelegate } = Root.cosmos;
...
MsgBeginRedelegate.prototype.GetDisplayContent = function () {
  const delegatorAddress = BECH32.encode(Config.cosmos.bech32.accAddr, this.DelegatorAddress);
  const validatorSrcAddress = BECH32.encode(Config.cosmos.bech32.valAddr, this.ValidatorSrcAddress);
  const validatorDstAddress = BECH32.encode(Config.cosmos.bech32.valAddr, this.ValidatorDstAddress);
