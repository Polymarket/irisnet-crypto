...
MsgSend.prototype.GetDisplayContent = function () {
  const from = BECH32.encode(Config.cosmos.bech32.accAddr, this.FromAddress);
  const to = BECH32.encode(Config.cosmos.bech32.accAddr, this.ToAddress);
  return {
