...
$root.cosmos = (function () {
  ...
  cosmos.MsgSend = (function () {
    ...
    MsgSend.encode = function encode(message, writer) {
      ...
      if (message.Amount != null && message.Amount.length) for (var i = 0; i < message.Amount.length; ++i) $root.cosmos.Coin.encode(message.Amount[i], writer.uint32(/* id 3, wireType 2 = */26).fork()).ldelim();
      return writer;
    };
  ...
  cosmos.MsgDelegate = (function () {
    ...
    MsgDelegate.toObject = function toObject(message, options) {
      ...
      var object = {};
      if (options.defaults) {
        if (options.bytes === String) object.DelegatorAddress = '';
        else {
      ...
      if (message.Amount != null && message.hasOwnProperty('Amount')) object.Amount = $root.cosmos.Coin.toObject(message.Amount, options);
      return object;
    };
  ...
  cosmos.MsgUndelegate = (function () {
    ...
    MsgUndelegate.fromObject = function fromObject(object) {
      ...
      if (object.Amount != null) {
        if (typeof object.Amount !== 'object') throw TypeError('.cosmos.MsgUndelegate.Amount: object expected');
        message.Amount = $root.cosmos.Coin.fromObject(object.Amount);
      }
      return message;
    };
  ...
  cosmos.MsgBeginRedelegate = (function () {
    ...
    MsgBeginRedelegate.fromObject = function fromObject(object) {
      ...
      if (object.Amount != null) {
        if (typeof object.Amount !== 'object') throw TypeError('.cosmos.MsgBeginRedelegate.Amount: object expected');
        message.Amount = $root.cosmos.Coin.fromObject(object.Amount);
      }
      return message;
    };
  ...
  cosmos.MsgSetWithdrawAddress = (function () {
    ...
    MsgSetWithdrawAddress.toObject = function toObject(message, options) {
      ...
      if (options.defaults) {
        ...
        if (options.bytes === String) object.WithdrawAddress = '';
        else {
  ...
  cosmos.MsgDeposit = (function () {
    ...
    MsgDeposit.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length; var
        message = new $root.cosmos.MsgDeposit();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    MsgDeposit.fromObject = function fromObject(object) {
      if (object instanceof $root.cosmos.MsgDeposit) return object;
      ...
      if (object.amount) {
        if (!Array.isArray(object.amount)) throw TypeError('.cosmos.MsgDeposit.amount: array expected');
        message.amount = [];
        for (var i = 0; i < object.amount.length; ++i) {
          if (typeof object.amount[i] !== 'object') throw TypeError('.cosmos.MsgDeposit.amount: object expected');
          message.amount[i] = $root.cosmos.Coin.fromObject(object.amount[i]);
        }
      }
      return message;
  ...
  cosmos.MsgVote = (function () {
    ...
    MsgVote.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length; var
        message = new $root.cosmos.MsgVote();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    MsgVote.fromObject = function fromObject(object) {
      if (object instanceof $root.cosmos.MsgVote) return object;
  ...
  cosmos.StdFee = (function () {
    ...
    StdFee.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.amount != null && message.amount.length) for (var i = 0; i < message.amount.length; ++i) $root.cosmos.Coin.encode(message.amount[i], writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim();
  ...
  cosmos.StdTx = (function () {
    ...
    StdTx.encode = function encode(message, writer) {
      ...
      if (message.signatures != null && message.signatures.length) for (var i = 0; i < message.signatures.length; ++i) $root.cosmos.StdSignature.encode(message.signatures[i], writer.uint32(/* id 3, wireType 2 = */26).fork()).ldelim();
    ...
    StdTx.toObject = function toObject(message, options) {
      ...
      if (message.signatures && message.signatures.length) {
        object.signatures = [];
        for (var j = 0; j < message.signatures.length; ++j) object.signatures[j] = $root.cosmos.StdSignature.toObject(message.signatures[j], options);
      }
