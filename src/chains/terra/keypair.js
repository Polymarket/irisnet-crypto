...
class TerraKeypair {
  static getPrivateKeyFromSecret(mnemonicS) {
    ...
    const derivedPriv = Hd.DerivePrivateKeyForPath(master.secret, master.chainCode, Config.terra.bip39Path);
    return derivedPriv;
  }
  ...
  static create(language) {
    ...
    pubKey = Amino.MarshalBinary(Config.terra.amino.pubKey, pubKey);
  ...
  static isValidAddress(address) {
    const prefix = Config.terra.bech32.accAddr;
