...
const { MsgSetWithdrawAddress } = Root.terra;
const { MsgWithdrawDelegatorReward } = Root.terra;
const { MsgWithdrawValidatorCommission } = Root.terra;

MsgSetWithdrawAddress.prototype.type = Config.terra.tx.setWithdrawAddress.prefix;
MsgSetWithdrawAddress.prototype.GetSignBytes = function () {
  const msg = {
    ...
    withdraw_address: BECH32.encode(Config.terra.bech32.accAddr, this.WithdrawAddress),
  };
...
MsgSetWithdrawAddress.prototype.toJSON = function () {
  const delegator_addr = BECH32.encode(Config.terra.bech32.accAddr, this.DelegatorAddress);
  const withdraw_addr = BECH32.encode(Config.terra.bech32.accAddr, this.WithdrawAddress);
  return {
    DelegatorAddress: delegator_addr,
    WithdrawAddress: withdraw_addr,
  };
...
MsgWithdrawDelegatorReward.prototype.type = Config.terra.tx.withdrawDelegatorReward.prefix;
...
MsgWithdrawDelegatorReward.prototype.toJSON = function () {
  const delegatorAddr = BECH32.encode(Config.terra.bech32.accAddr, this.DelegatorAddress);
  const validatorAddress = BECH32.encode(Config.terra.bech32.accAddr, this.ValidatorAddress);
  return {
...
MsgWithdrawValidatorCommission.prototype.type = Config.terra.tx.withdrawValidatorCommission.prefix;
