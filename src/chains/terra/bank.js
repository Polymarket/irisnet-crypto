...
const { MsgSend } = Root.terra;
MsgSend.prototype.GetSignBytes = function () {
  const msg = {
    from_address: BECH32.encode(Config.terra.bech32.accAddr, this.FromAddress),
    to_address: BECH32.encode(Config.terra.bech32.accAddr, this.ToAddress),
    amount: this.Amount,
  };
...
MsgSend.prototype.type = Config.terra.tx.transfer.prefix;
MsgSend.prototype.GetDisplayContent = function () {
  const from = BECH32.encode(Config.terra.bech32.accAddr, this.FromAddress);
  const to = BECH32.encode(Config.terra.bech32.accAddr, this.ToAddress);
  return {
