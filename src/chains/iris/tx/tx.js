  ...
  irisnet.tx = (function () {
    ...
    tx.Coin = (function () {
      ...
      Coin.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.Coin();
      ...
      Coin.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.Coin) return object;
    ...
    tx.Input = (function () {
      ...
      Input.encode = function encode(message, writer) {
        ...
        if (message.coins != null && message.coins.length) for (var i = 0; i < message.coins.length; ++i) $root.irisnet.tx.Coin.encode(message.coins[i], writer.uint32(/* id 2, wireType 2 = */18).fork()).ldelim();
        return writer;
      };
      ...
      Input.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.Input();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
        ...
        if (!message.hasOwnProperty('address')) throw $util.ProtocolError("missing required 'address'", { instance: message });
        return message;
      };
      ...
      Input.verify = function verify(message) {
        if (typeof message !== 'object' || message === null) return 'object expected';
        if (!(message.address && typeof message.address.length === 'number' || $util.isString(message.address))) return 'address: buffer expected';
      ...
      Input.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.Input) return object;
        var message = new $root.irisnet.tx.Input();
        if (object.address != null) {
          if (typeof object.address === 'string') $util.base64.decode(object.address, message.address = $util.newBuffer($util.base64.length(object.address)), 0);
          else if (object.address.length) message.address = object.address;
        }
        if (object.coins) {
          if (!Array.isArray(object.coins)) throw TypeError('.irisnet.tx.Input.coins: array expected');
          message.coins = [];
          for (var i = 0; i < object.coins.length; ++i) {
            if (typeof object.coins[i] !== 'object') throw TypeError('.irisnet.tx.Input.coins: object expected');
      ...
      Input.toObject = function toObject(message, options) {
        ...
        if (message.coins && message.coins.length) {
          object.coins = [];
          for (var j = 0; j < message.coins.length; ++j) object.coins[j] = $root.irisnet.tx.Coin.toObject(message.coins[j], options);
        }
        return object;
      };
    ...
    tx.Output = (function () {
      ...
      Output.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.Output();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
      ...
      Output.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.Output) return object;
        ...
        if (object.coins) {
          if (!Array.isArray(object.coins)) throw TypeError('.irisnet.tx.Output.coins: array expected');
          message.coins = [];
          for (var i = 0; i < object.coins.length; ++i) {
            if (typeof object.coins[i] !== 'object') throw TypeError('.irisnet.tx.Output.coins: object expected');
            message.coins[i] = $root.irisnet.tx.Coin.fromObject(object.coins[i]);
          }
        }
        return message;
    ...
    tx.MsgSend = (function () {
      ...
      MsgSend.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.input != null && message.input.length) for (var i = 0; i < message.input.length; ++i) $root.irisnet.tx.Input.encode(message.input[i], writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim();
        if (message.output != null && message.output.length) for (var i = 0; i < message.output.length; ++i) $root.irisnet.tx.Output.encode(message.output[i], writer.uint32(/* id 2, wireType 2 = */18).fork()).ldelim();
        return writer;
      };
      ...
      MsgSend.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.MsgSend();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
      ...
      MsgSend.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.MsgSend) return object;
        var message = new $root.irisnet.tx.MsgSend();
        if (object.input) {
          if (!Array.isArray(object.input)) throw TypeError('.irisnet.tx.MsgSend.input: array expected');
          message.input = [];
          for (var i = 0; i < object.input.length; ++i) {
            if (typeof object.input[i] !== 'object') throw TypeError('.irisnet.tx.MsgSend.input: object expected');
            message.input[i] = $root.irisnet.tx.Input.fromObject(object.input[i]);
          }
        }
        if (object.output) {
          if (!Array.isArray(object.output)) throw TypeError('.irisnet.tx.MsgSend.output: array expected');
          message.output = [];
          for (var i = 0; i < object.output.length; ++i) {
            if (typeof object.output[i] !== 'object') throw TypeError('.irisnet.tx.MsgSend.output: object expected');
      ...
      MsgSend.toObject = function toObject(message, options) {
        ...
        if (message.input && message.input.length) {
          object.input = [];
          for (var j = 0; j < message.input.length; ++j) object.input[j] = $root.irisnet.tx.Input.toObject(message.input[j], options);
        }
        if (message.output && message.output.length) {
          object.output = [];
          for (var j = 0; j < message.output.length; ++j) object.output[j] = $root.irisnet.tx.Output.toObject(message.output[j], options);
        }
        return object;
      };
    ...
    tx.MsgDelegate = (function () {
      ...
      MsgDelegate.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.MsgDelegate();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
        ...
        if (!message.hasOwnProperty('delegatorAddr')) throw $util.ProtocolError("missing required 'delegatorAddr'", { instance: message });
        if (!message.hasOwnProperty('validatorAddr')) throw $util.ProtocolError("missing required 'validatorAddr'", { instance: message });
        if (!message.hasOwnProperty('delegation')) throw $util.ProtocolError("missing required 'delegation'", { instance: message });
        return message;
      };
      ...
      MsgDelegate.verify = function verify(message) {
        if (typeof message !== 'object' || message === null) return 'object expected';
        if (!(message.delegatorAddr && typeof message.delegatorAddr.length === 'number' || $util.isString(message.delegatorAddr))) return 'delegatorAddr: buffer expected';
        if (!(message.validatorAddr && typeof message.validatorAddr.length === 'number' || $util.isString(message.validatorAddr))) return 'validatorAddr: buffer expected';
        {
          var error = $root.irisnet.tx.Coin.verify(message.delegation);
          if (error) return `delegation.${error}`;
        }
        return null;
      };
      ...
      MsgDelegate.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.MsgDelegate) return object;
        var message = new $root.irisnet.tx.MsgDelegate();
        if (object.delegatorAddr != null) {
          if (typeof object.delegatorAddr === 'string') $util.base64.decode(object.delegatorAddr, message.delegatorAddr = $util.newBuffer($util.base64.length(object.delegatorAddr)), 0);
          else if (object.delegatorAddr.length) message.delegatorAddr = object.delegatorAddr;
        }
        if (object.validatorAddr != null) {
          if (typeof object.validatorAddr === 'string') $util.base64.decode(object.validatorAddr, message.validatorAddr = $util.newBuffer($util.base64.length(object.validatorAddr)), 0);
          else if (object.validatorAddr.length) message.validatorAddr = object.validatorAddr;
        }
        if (object.delegation != null) {
          if (typeof object.delegation !== 'object') throw TypeError('.irisnet.tx.MsgDelegate.delegation: object expected');
      ...
      MsgDelegate.toObject = function toObject(message, options) {
        ...
        if (message.delegatorAddr != null && message.hasOwnProperty('delegatorAddr')) object.delegatorAddr = options.bytes === String ? $util.base64.encode(message.delegatorAddr, 0, message.delegatorAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.delegatorAddr) : message.delegatorAddr;
        if (message.validatorAddr != null && message.hasOwnProperty('validatorAddr')) object.validatorAddr = options.bytes === String ? $util.base64.encode(message.validatorAddr, 0, message.validatorAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.validatorAddr) : message.validatorAddr;
        if (message.delegation != null && message.hasOwnProperty('delegation')) object.delegation = $root.irisnet.tx.Coin.toObject(message.delegation, options);
        return object;
      };
    ...
    tx.MsgBeginUnbonding = (function () {
      ...
      MsgBeginUnbonding.encode = function encode(message, writer) {
        ...
        writer.uint32(/* id 1, wireType 2 = */10).bytes(message.delegatorAddr);
        writer.uint32(/* id 2, wireType 2 = */18).bytes(message.validatorAddr);
        const shares = message.sharesAmount.replace('.', ''); // fuck
      ...
      MsgBeginUnbonding.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.MsgBeginUnbonding();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
        ...
        if (!message.hasOwnProperty('delegatorAddr')) throw $util.ProtocolError("missing required 'delegatorAddr'", { instance: message });
        if (!message.hasOwnProperty('validatorAddr')) throw $util.ProtocolError("missing required 'validatorAddr'", { instance: message });
        if (!message.hasOwnProperty('sharesAmount')) throw $util.ProtocolError("missing required 'sharesAmount'", { instance: message });
        return message;
      };
      ...
      MsgBeginUnbonding.verify = function verify(message) {
        ...
        if (!(message.delegatorAddr && typeof message.delegatorAddr.length === 'number' || $util.isString(message.delegatorAddr))) return 'delegatorAddr: buffer expected';
        if (!(message.validatorAddr && typeof message.validatorAddr.length === 'number' || $util.isString(message.validatorAddr))) return 'validatorAddr: buffer expected';
        if (!$util.isString(message.sharesAmount)) return 'sharesAmount: string expected';
        return null;
      };
      ...
      MsgBeginUnbonding.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.MsgBeginUnbonding) return object;
        ...
        if (object.sharesAmount != null) message.sharesAmount = String(object.sharesAmount);
        return message;
      };
      ...
      MsgBeginUnbonding.toObject = function toObject(message, options) {
        ...
        if (message.delegatorAddr != null && message.hasOwnProperty('delegatorAddr')) object.delegatorAddr = options.bytes === String ? $util.base64.encode(message.delegatorAddr, 0, message.delegatorAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.delegatorAddr) : message.delegatorAddr;
        if (message.validatorAddr != null && message.hasOwnProperty('validatorAddr')) object.validatorAddr = options.bytes === String ? $util.base64.encode(message.validatorAddr, 0, message.validatorAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.validatorAddr) : message.validatorAddr;
        if (message.sharesAmount != null && message.hasOwnProperty('sharesAmount')) object.sharesAmount = message.sharesAmount;
        return object;
      };
    ...
    tx.MsgBeginRedelegate = (function () {
      ...
      MsgBeginRedelegate.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.MsgBeginRedelegate();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
        ...
        if (!message.hasOwnProperty('delegatorAddr')) throw $util.ProtocolError("missing required 'delegatorAddr'", { instance: message });
        if (!message.hasOwnProperty('validatorSrcAddr')) throw $util.ProtocolError("missing required 'validatorSrcAddr'", { instance: message });
        if (!message.hasOwnProperty('validatorDstAddr')) throw $util.ProtocolError("missing required 'validatorDstAddr'", { instance: message });
        if (!message.hasOwnProperty('sharesAmount')) throw $util.ProtocolError("missing required 'sharesAmount'", { instance: message });
        return message;
      };
      ...
      MsgBeginRedelegate.verify = function verify(message) {
        if (typeof message !== 'object' || message === null) return 'object expected';
        if (!(message.delegatorAddr && typeof message.delegatorAddr.length === 'number' || $util.isString(message.delegatorAddr))) return 'delegatorAddr: buffer expected';
        if (!(message.validatorSrcAddr && typeof message.validatorSrcAddr.length === 'number' || $util.isString(message.validatorSrcAddr))) return 'validatorSrcAddr: buffer expected';
        if (!(message.validatorDstAddr && typeof message.validatorDstAddr.length === 'number' || $util.isString(message.validatorDstAddr))) return 'validatorDstAddr: buffer expected';
        if (!$util.isString(message.sharesAmount)) return 'sharesAmount: string expected';
        return null;
      };
      ...
      MsgBeginRedelegate.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.MsgBeginRedelegate) return object;
        ...
        if (object.validatorSrcAddr != null) {
          if (typeof object.validatorSrcAddr === 'string') $util.base64.decode(object.validatorSrcAddr, message.validatorSrcAddr = $util.newBuffer($util.base64.length(object.validatorSrcAddr)), 0);
          else if (object.validatorSrcAddr.length) message.validatorSrcAddr = object.validatorSrcAddr;
        }
        if (object.validatorDstAddr != null) {
          if (typeof object.validatorDstAddr === 'string') $util.base64.decode(object.validatorDstAddr, message.validatorDstAddr = $util.newBuffer($util.base64.length(object.validatorDstAddr)), 0);
      ...
      MsgBeginRedelegate.toObject = function toObject(message, options) {
        ...
        if (message.delegatorAddr != null && message.hasOwnProperty('delegatorAddr')) object.delegatorAddr = options.bytes === String ? $util.base64.encode(message.delegatorAddr, 0, message.delegatorAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.delegatorAddr) : message.delegatorAddr;
        if (message.validatorSrcAddr != null && message.hasOwnProperty('validatorSrcAddr')) object.validatorSrcAddr = options.bytes === String ? $util.base64.encode(message.validatorSrcAddr, 0, message.validatorSrcAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.validatorSrcAddr) : message.validatorSrcAddr;
        if (message.validatorDstAddr != null && message.hasOwnProperty('validatorDstAddr')) object.validatorDstAddr = options.bytes === String ? $util.base64.encode(message.validatorDstAddr, 0, message.validatorDstAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.validatorDstAddr) : message.validatorDstAddr;
        if (message.sharesAmount != null && message.hasOwnProperty('sharesAmount')) object.sharesAmount = message.sharesAmount;
        return object;
      };
    ...
    tx.MsgWithdrawDelegatorRewardsAll = (function () {
      ...
      MsgWithdrawDelegatorRewardsAll.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.MsgWithdrawDelegatorRewardsAll();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
      ...
      MsgWithdrawDelegatorRewardsAll.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.MsgWithdrawDelegatorRewardsAll) return object;
    ...
    tx.MsgWithdrawDelegatorReward = (function () {
      ...
      MsgWithdrawDelegatorReward.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.MsgWithdrawDelegatorReward();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
      ...
      MsgWithdrawDelegatorReward.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.MsgWithdrawDelegatorReward) return object;
    ...
    tx.MsgDeposit = (function () {
      ...
      MsgDeposit.encode = function encode(message, writer) {
        ...
        if (message.amount != null && message.amount.length) for (var i = 0; i < message.amount.length; ++i) $root.irisnet.tx.Coin.encode(message.amount[i], writer.uint32(/* id 3, wireType 2 = */26).fork()).ldelim();
        return writer;
      };
      ...
      MsgDeposit.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.MsgDeposit();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
      ...
      MsgDeposit.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.MsgDeposit) return object;
        ...
        if (object.amount) {
          if (!Array.isArray(object.amount)) throw TypeError('.irisnet.tx.MsgDeposit.amount: array expected');
          message.amount = [];
          for (var i = 0; i < object.amount.length; ++i) {
            if (typeof object.amount[i] !== 'object') throw TypeError('.irisnet.tx.MsgDeposit.amount: object expected');
      ...
      MsgDeposit.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
          ...
          if (options.bytes === String) object.depositor = '';
          else {
            object.depositor = [];
        ...
        if (message.amount && message.amount.length) {
          object.amount = [];
          for (var j = 0; j < message.amount.length; ++j) object.amount[j] = $root.irisnet.tx.Coin.toObject(message.amount[j], options);
        }
        return object;
      };
    ...
    tx.MsgVote = (function () {
      ...
      MsgVote.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.MsgVote();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
      ...
      MsgVote.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.MsgVote) return object;
      ...
      MsgVote.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
          ...
          if (options.bytes === String) object.voter = '';
          else {
            object.voter = [];
    ...
    tx.StdFee = (function () {
      ...
      StdFee.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.amount != null && message.amount.length) for (var i = 0; i < message.amount.length; ++i) $root.irisnet.tx.Coin.encode(message.amount[i], writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim();
      ...
      StdFee.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.StdFee();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
      ...
      StdFee.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.StdFee) return object;
        var message = new $root.irisnet.tx.StdFee();
        if (object.amount) {
          if (!Array.isArray(object.amount)) throw TypeError('.irisnet.tx.StdFee.amount: array expected');
          message.amount = [];
          for (var i = 0; i < object.amount.length; ++i) {
            if (typeof object.amount[i] !== 'object') throw TypeError('.irisnet.tx.StdFee.amount: object expected');
            message.amount[i] = $root.irisnet.tx.Coin.fromObject(object.amount[i]);
          }
        }
        if (object.gas != null) {
    ...
    tx.StdSignature = (function () {
      ...
      StdSignature.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.StdSignature();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
        ...
        if (!message.hasOwnProperty('accountNumber')) throw $util.ProtocolError("missing required 'accountNumber'", { instance: message });
        if (!message.hasOwnProperty('sequence')) throw $util.ProtocolError("missing required 'sequence'", { instance: message });
        return message;
      };
      ...
      StdSignature.verify = function verify(message) {
        ...
        if (!$util.isInteger(message.accountNumber) && !(message.accountNumber && $util.isInteger(message.accountNumber.low) && $util.isInteger(message.accountNumber.high))) return 'accountNumber: integer|Long expected';
        if (!$util.isInteger(message.sequence) && !(message.sequence && $util.isInteger(message.sequence.low) && $util.isInteger(message.sequence.high))) return 'sequence: integer|Long expected';
        return null;
      };
      ...
      StdSignature.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.StdSignature) return object;
        ...
        if (object.accountNumber != null) {
          if ($util.Long) (message.accountNumber = $util.Long.fromValue(object.accountNumber)).unsigned = false;
          else if (typeof object.accountNumber === 'string') message.accountNumber = parseInt(object.accountNumber, 10);
          else if (typeof object.accountNumber === 'number') message.accountNumber = object.accountNumber;
          else if (typeof object.accountNumber === 'object') message.accountNumber = new $util.LongBits(object.accountNumber.low >>> 0, object.accountNumber.high >>> 0).toNumber();
        }
        if (object.sequence != null) {
          ...
          else if (typeof object.sequence === 'object') message.sequence = new $util.LongBits(object.sequence.low >>> 0, object.sequence.high >>> 0).toNumber();
        }
        return message;
      };
      ...
      StdSignature.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
          ...
          } else object.accountNumber = options.longs === String ? '0' : 0;
          if ($util.Long) {
            var long = new $util.Long(0, 0, false);
        ...
        if (message.accountNumber != null && message.hasOwnProperty('accountNumber')) {
          if (typeof message.accountNumber === 'number') object.accountNumber = options.longs === String ? String(message.accountNumber) : message.accountNumber;
          else object.accountNumber = options.longs === String ? $util.Long.prototype.toString.call(message.accountNumber) : options.longs === Number ? new $util.LongBits(message.accountNumber.low >>> 0, message.accountNumber.high >>> 0).toNumber() : message.accountNumber;
        }
        if (message.sequence != null && message.hasOwnProperty('sequence')) {
          if (typeof message.sequence === 'number') object.sequence = options.longs === String ? String(message.sequence) : message.sequence;
          else object.sequence = options.longs === String ? $util.Long.prototype.toString.call(message.sequence) : options.longs === Number ? new $util.LongBits(message.sequence.low >>> 0, message.sequence.high >>> 0).toNumber() : message.sequence;
        }
        return object;
      };
    ...
    tx.StdTx = (function () {
      ...
      StdTx.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.msgs != null && message.msgs.length) for (var i = 0; i < message.msgs.length; ++i) writer.uint32(/* id 1, wireType 2 = */10).bytes(message.msgs[i]);
        $root.irisnet.tx.StdFee.encode(message.fee, writer.uint32(/* id 2, wireType 2 = */18).fork()).ldelim();
        if (message.signatures != null && message.signatures.length) for (var i = 0; i < message.signatures.length; ++i) $root.irisnet.tx.StdSignature.encode(message.signatures[i], writer.uint32(/* id 3, wireType 2 = */26).fork()).ldelim();
      ...
      StdTx.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length; var
          message = new $root.irisnet.tx.StdTx();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
              if (!(message.msgs && message.msgs.length)) message.msgs = [];
      ...
      StdTx.verify = function verify(message) {
        ...
        if (message.msgs != null && message.hasOwnProperty('msgs')) {
          if (!Array.isArray(message.msgs)) return 'msgs: array expected';
          for (var i = 0; i < message.msgs.length; ++i) if (!(message.msgs[i] && typeof message.msgs[i].length === 'number' || $util.isString(message.msgs[i]))) return 'msgs: buffer[] expected';
        }
        {
      ...
      StdTx.fromObject = function fromObject(object) {
        if (object instanceof $root.irisnet.tx.StdTx) return object;
        var message = new $root.irisnet.tx.StdTx();
        if (object.msgs) {
          if (!Array.isArray(object.msgs)) throw TypeError('.irisnet.tx.StdTx.msgs: array expected');
          message.msgs = [];
          for (var i = 0; i < object.msgs.length; ++i) {
            if (typeof object.msgs[i] === 'string') $util.base64.decode(object.msgs[i], message.msgs[i] = $util.newBuffer($util.base64.length(object.msgs[i])), 0);
            else if (object.msgs[i].length) message.msgs[i] = object.msgs[i];
          }
        }
        if (object.fee != null) {
          if (typeof object.fee !== 'object') throw TypeError('.irisnet.tx.StdTx.fee: object expected');
          message.fee = $root.irisnet.tx.StdFee.fromObject(object.fee);
        }
        if (object.signatures) {
          if (!Array.isArray(object.signatures)) throw TypeError('.irisnet.tx.StdTx.signatures: array expected');
          message.signatures = [];
          for (var i = 0; i < object.signatures.length; ++i) {
            if (typeof object.signatures[i] !== 'object') throw TypeError('.irisnet.tx.StdTx.signatures: object expected');
      ...
      StdTx.toObject = function toObject(message, options) {
        ...
        if (message.msgs && message.msgs.length) {
          object.msgs = [];
          for (var j = 0; j < message.msgs.length; ++j) object.msgs[j] = options.bytes === String ? $util.base64.encode(message.msgs[j], 0, message.msgs[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.msgs[j]) : message.msgs[j];
        }
        if (message.fee != null && message.hasOwnProperty('fee')) object.fee = $root.irisnet.tx.StdFee.toObject(message.fee, options);
        if (message.signatures && message.signatures.length) {
          object.signatures = [];
          for (var j = 0; j < message.signatures.length; ++j) object.signatures[j] = $root.irisnet.tx.StdSignature.toObject(message.signatures[j], options);
        }
